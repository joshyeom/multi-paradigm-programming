...
본 도서 『멀티패러다임 프로그래밍』은 [한빛미디어](https://www.hanbit.co.kr/)에서 출판되었습니다. 본 저장소에 공개된 책 내용은 저자가 직접 탈고한 원고로, 일부 문장이나 표현이 다소 미흡할 수 있습니다. 한빛미디어 편집자 이윤지 님께서 완성도를 높여 편집한 정식 출간본(종이책 및 전자책)은 더욱 매끄럽고 전달력이 향상된 형태로 만나보실 수 있습니다. 
